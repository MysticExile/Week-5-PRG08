...
addOne.addEventListener("click", () => learnOne());
addTwo.addEventListener("click", () => learnTwo());
addThree.addEventListener("click", () => learnThree());
...
//
// predict the finger position in the camera
//
